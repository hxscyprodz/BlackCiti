...
export default function About () {
    return(
        <Element name='About' className="py-30 px-20 flex flex-col gap-5">
            <Values />
            <div className="flex flex-col justify-center items-center gap-5 mt-20 bg-gray-100 p-5 rounded-2xl">
                <h1 className="text-4xl font-bold text-gray-800">Our <span className="text-blue-800">Story</span></h1>
